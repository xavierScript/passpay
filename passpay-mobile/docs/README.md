# 📚 PassPay Documentation

Comprehensive documentation for integrating LazorKit SDK in React Native (Expo) applications.
...
- [**Installation & Setup**](./INSTALLATION.md) - Detailed setup guide with polyfills and configuration
